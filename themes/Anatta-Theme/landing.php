...
<div id="container"> 
  ...
  <section id="content">
    <section class="wrapper">
      ...
      <section class="video"> <script type="text/javascript" src="http://content.bitsontherun.com/players/dlAyH2p5-yPfOz2CI.js"></script> </section>
               		...
               		// Validation
        				...
        				if($api->listSubscribe($list_id, $_REQUEST['EMAIL'], $mergeVars) === true) {
                           ...
                           <script type="text/javascript">
        						<!--
        						window.location = "<?php bloginfo('url'); ?>/thanks/";
        						//-->
        						</script>
